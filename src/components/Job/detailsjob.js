...
export default function Details(){
   ...
   return(
        <><div className='flex w-full font-thin bg-white text-gray-500 shadow-sm rounded-sm mb-2'>
           ...
           <div className='flex-1 p-3 flex flex-col'>
               <div className='text-xs self-end'>
                   {job.jobPostedAt ?? job.jobPostedAt}
               </div>
               <h3 className='text-lg text-red-500 py-2'>{job.title}</h3>
               <div className='flex'>
                   <div className='flex-1 flex flex-col'>
                       <div className='text-xs flex items-center mb-2'>
                           ...
                           <ItemWithSvg
                               label={job.jobContrat ?? job.jobContrat}
                       ...
                       <p> Source: {job.jobSource ?? job.jobSource} </p>
                       <p>
                           Le salaire est de {job.salaryRange ?? job.salaryRange}
                       </p>
                   </div>
       ...
       </div><div className='left-80' >
               <button className='h-full  py-1 px-4 border border-red-500 rounded-sm text-red-500 hover:text-white hover:bg-red-500 transition ease-in-out'>
                   Postuler
               </button>
           </div>
           <div >
